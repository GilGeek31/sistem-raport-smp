                ...
                <form action="{{ route('tahun-ajaran.update', $tahunAjaran) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="semester" class=" mt-1 block w-full rounded border-gray-300">
                            ...
                            @php $semesterLama = old('semester', $tahunAjaran->semester); @endphp
                            <option value="ganjil" {{ $semesterLama == 'ganjil' ? 'selected' : '' }}>Ganjil</option>
                            <option value="genap" {{ $semesterLama == 'genap' ? 'selected' : '' }}>Genap</option>
                        </select>
                        @error('semester')
